      ...
      <div className="container mx-auto p-4">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <h2 className="text-xl font-semibold mb-3">Seus Hábitos Salvos</h2>
              {usuario.habitos && usuario.habitos.length > 0 ? (
                ...
                <p>Você ainda não tem hábitos salvos. Use o formulário ao lado para receber sugestões personalizadas!</p>
              )}
            </Card>
            
            <Card>
              <h2 className="text-xl font-semibold mb-3">Olá, {usuario.nome}!</h2>
              <p className="mb-3">Aqui estão algumas sugestões de hábitos para você em {usuario.cidade}.</p>
              <HabitSuggestion />
            </Card>
          </div>
        )}
