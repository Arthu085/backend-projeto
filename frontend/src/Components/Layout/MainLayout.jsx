...
export default function MainLayout({ children }) {
	...
	const navigation = [
		...
		{ name: "Sugestões", href: "/suggestions", icon: "✨" },
	];
		...
		<div className="flex h-screen bg-gray-300">
			...
			<div className="hidden md:flex md:flex-shrink-0">
				<div className="flex flex-col w-64">
					<div className="flex flex-col flex-1 h-0 bg-gray-400 border-r border-gray-200">
						<div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
							{/* Logo */}
							<div className="flex items-center flex-shrink-0 px-4">
								<span className="ml-2 text-xl font-bold">Equilíbrio AI</span>
							</div>

							{/* Navigation */}
							<nav className="flex-1 px-2 mt-5 space-y-1 bg-gray-400">
								{navigation.map((item) => (
									<Link
										key={item.name}
										to={item.href}
